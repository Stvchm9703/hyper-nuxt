...
export function state(msg: any) { _log(_style.status('    ' + msg, '     ')) }
export function success(msg: any) { _log(_style.success('\t', msg, '\t')) }
export function info(msg: any) { _log(msg) }
export function warn(msg: any) {
  ...
  if (typeof msg === 'string') {
    ...
    _log(
      util.formatWithOptions({ colors: true }, '%O', msg)
    )
  }
